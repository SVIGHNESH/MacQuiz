...
import {
    X, Upload, AlertTriangle, ShieldCheck, Key, Eye, EyeOff, RefreshCw, Copy, Save
} from 'lucide-react';
import { validatePasswordStrength, generateStrongPassword, validateEmailDomain } from "../../utils/dashboardHelpers";
